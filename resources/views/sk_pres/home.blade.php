        ...
        <div class="p-6 overflow-y-auto">
            ...
            <div class="bg-white p-5 rounded-xl shadow mb-6">
                ...
                <div class="flex gap-3 flex-wrap">
                    <button id="postAnnouncement" type="button" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg">
                        Create Announcement
                    </button>

                    <button id="postEvent" type="button" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg">
                        Manage Events
                    </button>

                    <button id="postMeeting" type="button" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
                        Schedule Meeting
                    </button>
                </div>
            </div>
...
<script>
    ...
    const postMeeting = document.getElementById('postMeeting');
    ...
    postEvent.addEventListener('click', function () {
        openPostModal('event');
    });

    postMeeting.addEventListener('click', function () {
        openPostModal('accomplishment');
    });
