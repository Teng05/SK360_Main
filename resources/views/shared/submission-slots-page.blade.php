                        ...
                        @forelse ($slots as $slot)
                            ...
                            <div class="rounded-2xl border border-red-100 bg-red-50/30 p-5">
                                ...
                                <div class="mt-4 flex justify-end">
                                    ...
                                    @elseif (!empty($slot->has_submitted) && empty($allowResubmission))

                                        <button
                                            type="button"
                                            class="rounded-xl bg-green-600 px-4 py-3 text-xs font-black uppercase text-white cursor-default"
                                        >
                                            Submitted
                                        </button>
                                    ...
                                    @else
                                        ...
                                        <button
                                            type="button"
                                            class="rounded-xl {{ !empty($slot->has_submitted) ? 'bg-amber-500 hover:bg-amber-600' : 'bg-red-600 hover:bg-red-700' }} px-4 py-3 text-xs font-black uppercase text-white"
                                ...
                                @forelse ($submissions as $submission)
                                    ...
                                    <tr class="hover:bg-gray-50 transition border-b border-gray-50">
                                        ...
                                        <td class="px-6 py-5">
                                            ...
                                            <span class="{{ $submission->status_badge }} px-3 py-1 rounded-full text-[9px] font-black uppercase">
                                                {{ $submission->status }}
                                            </span>
