...
@section('content')
@php
    $secretaryInitials=strtoupper(
        substr(auth()->user()->first_name ?? 'S',0,1).
        substr(auth()->user()->last_name ?? 'S',0,1)
    );
@endphp
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50">
            <div class="max-w-5xl mx-auto px-8 py-8">
                ...
                <form method="GET"
                      action="{{ route('sk_secretary.announcements') }}"
                    ...
                    @if($search!=='')
                        <div class="mt-3 flex items-center justify-between">
                            ...
                            <a href="{{ route('sk_secretary.announcements') }}"
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center justify-between mt-3">
                            <p class="text-[10px] text-gray-400">
                                Posting as {{ $fullName }} • SK Secretary
                            </p>
