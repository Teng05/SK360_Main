            ...
            <section class="bg-white rounded-[28px] shadow-sm border border-gray-100 p-6 xl:p-8">
                <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-500">View president-created meetings and scheduled sessions</p>
                    </div>
                </div>
                            ...
                            @forelse ($activeMeetings as $meeting)
                                <div class="rounded-2xl border border-red-100 bg-white p-4 shadow-sm">
                                    ...
                                    <div class="mt-4 flex flex-wrap gap-2">
                                        <a href="{{ route('sk_chairman.meetings.call',$meeting->meeting_id) }}" class="inline-flex items-center rounded-xl bg-[#d90f1f] px-4 py-2 text-xs font-semibold text-white transition hover:bg-[#b90e1b]">Join Video Call</a>
