...
<div class="min-h-screen bg-gray-100 flex items-center justify-center px-6">
    <div class="max-w-xl w-full bg-white rounded-3xl shadow-lg border border-gray-200 p-10 text-center">
        ...
        <a href="{{ route('sk_chairman.home') }}" class="inline-flex items-center justify-center rounded-xl bg-red-600 px-5 py-3 text-white font-semibold hover:bg-red-700 transition">
            Back to Home
        </a>
    </div>
</div>
