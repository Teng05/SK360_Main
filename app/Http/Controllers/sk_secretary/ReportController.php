...
class ReportController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            $reportId = DB::transaction(function () use ($data, $slot, $existingReport) {
        ...
        $this->notifyPresidentOfReportSubmission($reportId, $isResubmission);

        if ($isResubmission) {
            return redirect()
                ->route('sk_secretary.reports')
                ->with(
                    'report_success',
    ...
    protected function notifyPresidentOfReportSubmission(int $reportId, bool $isResubmission): void
    {
